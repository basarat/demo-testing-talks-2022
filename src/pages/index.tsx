  ...
  return (
    <footer className={classNames.footer}>
      ...
      <ul className={classNames.filters}>
        <li>
          <a data-test="all" className={routerSnap.route === 'all' ? classNames.selected : ''} href={link(routes.all)}>All</a>
          <a data-test="active" className={routerSnap.route === 'active' ? classNames.selected : ''} href={link(routes.active)}>Active</a>
          <a data-test="completed" className={routerSnap.route === 'completed' ? classNames.selected : ''} href={link(routes.completed)}>Completed</a>
        </li>
      </ul>
      {
        appSnap.completedCount > 0 &&
        <button className={classNames.clearCompleted} onClick={() => appSnap.clearCompleted()}>Clear completed</button>
      }
    </footer>
  );
});
